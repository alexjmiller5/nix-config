<!-- GENERATED by `just manual` from https://github.com/alexjmiller5/nix-config/commit/417b9ceaf2d6e8dafd9515b997e0a1948b01140b-dirty - edit the declaring nix module or docs/manual/macbook-air-bootstrap.md, then rerun. -->
...
### Log out after the first Hyper key activation (hyper-key · shell)
...
Verify: `capture-snapshot chrome-ui --diff /nix/store/5zp1z3az06kjz25226wqpzmbiri90bfj-chrome-ui.txt`
...
Verify: `capture-snapshot tcc --diff /nix/store/2m030j127yr4fqw8hc34iak2ssfi3j7q-tcc.txt`
